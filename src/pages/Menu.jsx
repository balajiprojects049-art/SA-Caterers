                                ...
                                >
                                    ...
                                    <ul className="space-y-4 mb-8">
                                        {(premiumDiet === 'vegetarian' ? [
                                            ...
                                            'SALAD COUNTER', 'Welcome Drinks --- Three', 'Soup - Veg --- One', 'Welcome Snacks (Veg) --- Three', 'Welcome Snacks (Non-Veg) --- Two', 'Snacks for Cocktail Non-Veg', 'Prawns --- One', 'Vegetarian --- Four', 'Chat Counter --- Five', 'South Indian --- Four', 'Roties --- three', 'Chicken --- One', 'Mutton Curry --- One', 'Egg Curry --- One', 'Biryani (Mutton or Chicken) --- One', 'Veg North Curryes --- Two', 'Veg South Indian Curryes --- Two', 'Veg Biryani --- One', 'Flever Rice --- One', 'Dal Item --- One', 'Sambar or Pappucharu --- One', 'Fruit Counter --- 5+5', 'Sweet --- Three', 'Ice Cream Counter --- Three', 'Pan Counter', 'For Cocktail On Actuals', '--- Common Items ---', 'Plain Rice', 'Vadiyalu', 'Curd', 'Raitha', 'Ghee', 'Green Salad', 'Sweet Pan', 'Uramirapakayalu', 'Papad', '200 ML Water Bottles for Welcome', 'Pickles'
                                        ]).map((item, idx) => {
