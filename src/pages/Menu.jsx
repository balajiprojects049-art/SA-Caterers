                        ...
                        <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                                ...
                                >
                                    ...
                                    <ul className="space-y-4 mb-8">
                                        {(premiumDiet === 'vegetarian' ? [
                                            'Welcome Juice', 'Welcome Snack', 'Sweet', 'Hot', 'Roti(Min 100 Members)', 'Special Rice/Biryani', 'Raitha', 'South Indian Curry(2)', 'North Indian Curry(2)', 'Veg Fry Item', 'Veg Dry Item', 'Pappu', 'Sambar', 'Roti Pachadi', 'Pickle', 'White Rice', 'Curd', 'Papad', 'Veg Salad', 'Sweet Soump', 'Ice Cream'
                                        ] : [
                                            'Welcome Juice', 'Welcome Snack', 'Sweet', 'Hot', 'Roti(min 100 Members)', 'Veg Biryani/Pulao', 'Non Veg Biryani/Pulao', 'Raitha', 'South Indian Curry(2)', 'North Indian Curry(2)', 'Veg Fry Item', 'Veg Dry Item', 'Pappu', 'Sambar', 'Roti Pachadi', 'Pickle', 'White Rice', 'Curd', 'Papad', 'Veg Salad', 'Sweet Soump', 'Sweet Pan', 'Fish/Prawans (fry/Curry)', 'Chicken Fry', 'Mutton Curry', 'Ice Cream'
                                        ]).map((item, idx) => (
                                            <li key={idx} className="flex items-start text-gray-800">
                                                <Check size={18} className="text-green-500 mr-3 mt-1 flex-shrink-0" />
                                                <span>{item}</span>
                                    ...
                                    <button
                                        onClick={() => handlePremiumPlanSelect('Diamond', premiumDiet === 'vegetarian' ? ['Welcome Juice', 'Welcome Snack', 'Sweet', 'Hot', 'Roti(Min 100 Members)', 'Special Rice/Biryani', 'Raitha', 'South Indian Curry(2)', 'North Indian Curry(2)', 'Veg Fry Item', 'Veg Dry Item', 'Pappu', 'Sambar', 'Roti Pachadi', 'Pickle', 'White Rice', 'Curd', 'Papad', 'Veg Salad', 'Sweet Soump', 'Ice Cream'] : ['Welcome Juice', 'Welcome Snack', 'Sweet', 'Hot', 'Roti(min 100 Members)', 'Veg Biryani/Pulao', 'Non Veg Biryani/Pulao', 'Raitha', 'South Indian Curry(2)', 'North Indian Curry(2)', 'Veg Fry Item', 'Veg Dry Item', 'Pappu', 'Sambar', 'Roti Pachadi', 'Pickle', 'White Rice', 'Curd', 'Papad', 'Veg Salad', 'Sweet Soump', 'Sweet Pan', 'Fish/Prawans (fry/Curry)', 'Chicken Fry', 'Mutton Curry', 'Ice Cream'])}
                                        className="w-full py-3 bg-[#8b5e34] text-[17px] text-white font-bold rounded-lg hover:bg-[#6e4928] transition-colors relative overflow-hidden"
                                    >
                                        <span className="relative z-10">Choose Plan</span>
                                    </button>
                                ...
                                >
                                    ...
                                    <ul className="space-y-4 mb-8">
                                        {(premiumDiet === 'vegetarian' ? [
                                            'Mocktail Counter', 'Welcome Juice --- Two', 'Welcome Snacks (Veg) --- Three', 'Salad Live', 'Chat --- Five', 'Chinese --- Five', 'Italian --- Three', 'Panjabi Dhaba (or) South Indian --- Four', "Roti's --- Four", 'North Indian Curries --- Two', 'South Indian Curries --- Two', 'Fry items --- One', 'Biryani --- One', 'Flever Rice --- One', 'Dal Item --- Two', 'Sambar or Pappucharu --- One', 'Rasam --- One', 'Sweet Mela (for Head 3 Pices)', 'Fresh Fruit Counter --- 5+5', 'Pan Counter', '--- Common Items ---', 'Plain Rice', 'Curd', 'Ghee', 'Sweet Pan', 'Papad', 'Pickles', 'Vadiyalu', 'Raitha', 'Green Salad', 'Uramirapakayalu', '200 ML Water Bottle'
                                        ] : [
                                            'SALAD COUNTER', 'Welcome Drinks --- Three', 'Soup - Veg --- One', 'Welcome Snacks (Veg) --- Three', 'Welcome Snacks (Non-Veg) --- Two', 'Snacks for Cocktail Non-Veg', 'Prawns --- One', 'Vegetarian --- Four', 'Chat Counter --- Five', 'South Indian --- Four', 'Roties --- three', 'Chicken --- One', 'Mutton Curry --- One', 'Egg Curry --- One', 'Non-Veg fry --- One', 'Biryani (Mutton or Chicken) --- One', 'Veg North Curryes --- Two', 'Veg South Indian Curryes --- Two', 'Veg Biryani --- One', 'Flever Rice --- One', 'Dal Item --- One', 'Sambar or Pappucharu --- One', 'Fruit Counter --- 5+5', 'Sweet --- Three', 'Ice Cream Counter --- Three', 'Pan Counter', 'For Cocktail On Actuals', '--- Common Items ---', 'Plain Rice', 'Vadiyalu', 'Curd', 'Raitha', 'Ghee', 'Green Salad', 'Sweet Pan', 'Uramirapakayalu', 'Papad', '200 ML Water Bottles for Welcome', 'Pickles'
                                        ]).map((item, idx) => {
                                    ...
                                    <button
                                        onClick={() => handlePremiumPlanSelect('Platinum', premiumDiet === 'vegetarian' ? ['Mocktail Counter', 'Welcome Juice --- Two', 'Welcome Snacks (Veg) --- Three', 'Salad Live', 'Chat --- Five', 'Chinese --- Five', 'Italian --- Three', 'Panjabi Dhaba (or) South Indian --- Four', "Roti's --- Four", 'North Indian Curries --- Two', 'South Indian Curries --- Two', 'Fry items --- One', 'Biryani --- One', 'Flever Rice --- One', 'Dal Item --- Two', 'Sambar or Pappucharu --- One', 'Rasam --- One', 'Sweet Mela (for Head 3 Pices)', 'Fresh Fruit Counter --- 5+5', 'Pan Counter', 'Plain Rice', 'Curd', 'Ghee', 'Sweet Pan', 'Papad', 'Pickles', 'Vadiyalu', 'Raitha', 'Green Salad', 'Uramirapakayalu', '200 ML Water Bottle'] : ['SALAD COUNTER', 'Welcome Drinks --- Three', 'Soup - Veg --- One', 'Welcome Snacks (Veg) --- Three', 'Welcome Snacks (Non-Veg) --- Two', 'Snacks for Cocktail Non-Veg', 'Prawns --- One', 'Vegetarian --- Four', 'Chat Counter --- Five', 'South Indian --- Four', 'Roties --- three', 'Chicken --- One', 'Mutton Curry --- One', 'Egg Curry --- One', 'Non-Veg fry --- One', 'Biryani (Mutton or Chicken) --- One', 'Veg North Curryes --- Two', 'Veg South Indian Curryes --- Two', 'Veg Biryani --- One', 'Flever Rice --- One', 'Dal Item --- One', 'Sambar or Pappucharu --- One', 'Fruit Counter --- 5+5', 'Sweet --- Three', 'Ice Cream Counter --- Three', 'Pan Counter', 'For Cocktail On Actuals', 'Plain Rice', 'Vadiyalu', 'Curd', 'Raitha', 'Ghee', 'Green Salad', 'Sweet Pan', 'Uramirapakayalu', 'Papad', '200 ML Water Bottles for Welcome', 'Pickles'])}
                                        className="w-full py-3 bg-[#8b5e34] text-[17px] text-white font-bold rounded-lg hover:bg-[#6e4928] transition-colors relative overflow-hidden"
                                    >
                                        <span className="relative z-10">Choose Plan</span>
                                    </button>
