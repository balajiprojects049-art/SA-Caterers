                        ...
                        <div>
                            ...
                            <ul className="space-y-3">
                                {[
                                    ...
                                    { label: 'Private Parties', path: '/contact' },
                                    { label: 'Live Counters', path: '/menu' },
                                    { label: 'Outdoor Catering', path: '/contact' }
                                ].map((item) => (
                                    <li key={item.label}>
                                        <Link to={item.path} className="text-gray-400 hover:text-luxury-gold transition-colors inline-block text-[15px] hover:translate-x-1 transform duration-200">
                                            {item.label}
                                        </Link>
                                    </li>
                                ))}
                    ...
                    <div>
                        ...
                        <ul className="space-y-5">
                            <li className="flex items-start">
                                ...
                                <span className="text-gray-400 text-[15px] leading-relaxed">Plot number 4, RTC Colony, Tirumalgherry, Secunderabad, 500015</span>
                            </li>
                            <li className="flex items-center">
                                ...
                                <a href="tel:9030927239" className="text-gray-400 hover:text-luxury-gold transition-colors text-[15px]">+91 90309 27239 /+91 88010 02808</a>
                            </li>
                            <li className="flex items-center">
                                <div className="w-8 h-8 rounded-full bg-luxury-gold/10 flex items-center justify-center mr-4 flex-shrink-0">
